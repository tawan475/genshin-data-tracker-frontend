...
<template>
  <div class="relative overflow-x-auto border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 shadow-sm w-full min-h-[150px] transition-colors">
